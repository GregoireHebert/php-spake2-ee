...
int
crypto_spake_server_store(unsigned char stored_data[164],
                          const char * const salt,
...
int
crypto_spake_validate_public_data(const unsigned char public_data[36],
